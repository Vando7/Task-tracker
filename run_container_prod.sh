...
trap 'docker-compose -f /home/vanko/personal_projects/tracker/production.yml down' INT

docker-compose -f /home/vanko/personal_projects/tracker/production.yml up
